...
Diese Anleitung führt dich durch die Schritte, die erforderlich sind, um "registrations" Kollektion in die MongoDB-Datenbank zu importieren. Bitte folge den Anweisungen sorgfältig.
...
Im CMD gibst du dann diesen MongoImport-Befehl ein: mongoimport --uri mongodb://<DeinServer>:<Port>/<DeineDatenbank> --collection registrations --type json --file <PfadZurImportdatei> --jsonArray. Dieser muss dann korrekt angepasst werden.

Mein Beispiel: ´mongoimport --uri mongodb://localhost:27017/M165Azin --collection registrations --type json --file C:\Github\M165Projekt\M165Azin\Back-end\SkiService-Backend\DatenbankImports\DatenbankImport.txt --jsonArray´

### Schritt 4: In der MongoDb die Kollektion abrufen.
Mit ´db.registrations.find()´ siehst du all den Inhalt in der registrations Kollektion.