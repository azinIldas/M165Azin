...
Im CMD gibst du dann diesen MongoImport-Befehl ein: mongoimport --uri mongodb://<DeinServer>:<Port>/<DeineDatenbank> --collection userInfos --type json --file <PfadZurImportdatei> --jsonArray. Dieser muss dann korrekt angepasst werden.

Mein Beispiel: ´mongoimport --uri mongodb://localhost:27017/M165Azin --collection userInfos --type json --file C:\Github\M165Projekt\M165Azin\Back-end\SkiService-Backend\DatenbankImports\DatenbankImport2.txt --jsonArray´


### Schritt 4: In der MongoDb die Kollektion abrufen.
Mit ´db.userInfos.find()´ siehst du all den Inhalt in der userInfos Kollektion.